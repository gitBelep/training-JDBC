...
public class VaccinationListTypeTest {

    private Vaccination list;

    @BeforeEach
    public void setUp() {
        list = new Vaccination();
        try (BufferedReader br = new BufferedReader(new InputStreamReader(VaccinationListTypeTest.class.getResourceAsStream("/vaccinationlist_2021-03-02_1234.csv")))) {
